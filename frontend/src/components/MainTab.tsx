...
import {Field, NumberInput, Select, TextInput} from '@/src/components/FormControls';
...
export function MainTab({postTypes, main, setMain}: Props) {
    ...
    return (
        <div className="wralm-panel">
            ...
            <Field label="Type Pagination"
                   htmlFor="type_pagination">
                <Select
                    id="type_pagination"
            ...
            <Field label="Count Post Per page"
                   htmlFor="count_post_per_page">
                <NumberInput
            ...
            <Field label="Load more label"
                   htmlFor="load_more_label">
                <TextInput
                    id="load_more_label"
