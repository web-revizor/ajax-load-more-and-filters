...
import {Checkbox, Field, Select, TextInput} from "@/src/components/FormControls";
    ...
    return (
        <div className="wralm-panel">
            ...
            {filters.filterByCategory && (
                <>
                    <Field label="Filter by taxonomy"
                           htmlFor="filter_taxonomy">
                        <select
                            id="filter_taxonomy"
                    ...
                    <Field label="Filter row classes"
                           htmlFor="filter_row_classes">
                        <TextInput
                    ...
                    <Field label="Filter item classes"
                           htmlFor="filter_item_classes">
                        <TextInput
                    ...
                    <Field label="Label all category button"
                           htmlFor="all_category_button">
                        <TextInput
