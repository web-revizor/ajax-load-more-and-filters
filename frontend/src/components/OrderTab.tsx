...
import {Checkbox, Field, TextInput} from '@/src/components/FormControls';
...
export function OrderTab({order, setOrder}: Props) {
    ...
    return (
        <div className="wralm-panel">
            ...
            {order.enableOrder && (
                <>
                    <Field label="Label Newest"
                           htmlFor="label_newest_order">
                        <TextInput
                    ...
                    <Field label="Label Old"
                           htmlFor="label_old_order">
                        <TextInput
                            id="label_old_order"
