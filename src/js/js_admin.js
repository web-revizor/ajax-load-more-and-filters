...
jQuery(function ($) {
    ...
    function generateShortCode() {
        var post_type_val = $('#post_type_load_more').find(":selected").val(),
        ...
        shortCodeArray.push(' post_type="' + post_type_val + '"' + ' posts_per_page="' + countPosts_val + '"' + ' type_pagination="' + type_pagination_val + '"')
        ...
        if ($('#filter_by_category').is(':checked')) {
            ...
            if (filter_item_classes_val !== '') {
                shortCodeArray.push(' filter_item_classes="' + filter_item_classes_val + '"')
            }
        ...
        if ($('#enable_search').is(':checked')) {
            ...
            if (label_search_button_val !== '') {
                shortCodeArray.push(' label_search_button="' + label_search_button_val + '"')
            }
            if (search_placeholder_val !== '') {
                shortCodeArray.push(' search_placeholder="' + search_placeholder_val + '"')
            }
        } else {
            $('.hiddenSearch').hide();
        }
        ...
        if ($('#enable_order').is(':checked')) {
            ...
            if (label_newest_order_val !== '') {
                shortCodeArray.push(' label_newest_order="' + label_newest_order_val + '"')
            }
